...
public class Solver {
	...
	private static Node shortest = new Node(-1, -1, Integer.MAX_VALUE, null);
	private static char[][] maze = new char[1][];
	...
	private static void solve(Node node, boolean[][] visited) {
	...
	static class Node implements Comparable<Node> {
		...
		Node(int r, int c, int distance, Node prev) {
			this.r = r;
			this.c = c;
